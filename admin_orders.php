...
if (isset($_POST['update_order'])) {
   ...
   // Check if the 'update_payment' key exists in the $_POST array
   if (isset($_POST['update_payment'])) {
      $update_payment = $_POST['update_payment'];

      // Check if payment status is already completed
      $select_payment_status = mysqli_query($conn, "SELECT payment_status FROM `orders` WHERE id = '$order_update_id'");
      $payment_status = mysqli_fetch_assoc($select_payment_status)['payment_status'];
      if ($payment_status === 'completed') {
         $message[] = 'Payment status is already completed!';
      } else {
